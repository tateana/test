...
===========================
The module has been changed to support bootstrap v.3
-------------------------------------------------
...
- [Zend Framework 2.1.4](https://github.com/zendframework/zf2/tree/release-2.1.4)
- Twitter Bootstrap v2.1.0
- The module has been changed by Currency Solutions to support botstrap v.3  
--------------------------------------------------------------
