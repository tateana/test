...
class HelperConfig implements ConfigInterface
{
    ...
    protected $invokables = array(
        ...
        'formhelptwb'                           => 'DluTwBootstrap\Form\View\Helper\FormHelpTwb',
    ...
    protected function getFactories()
    {
        ...
        return array(
            ...
            'formfontpickertwb'                 => function($sm) use ($genUtil, $formUtil) {
                $instance       = new \DluTwBootstrap\Form\View\Helper\FormFontPickerTwb($genUtil, $formUtil);
                return $instance;
            },
            'formslidertwb'                 => function($sm) use ($genUtil, $formUtil) {
                $instance       = new \DluTwBootstrap\Form\View\Helper\FormSliderTwb($genUtil, $formUtil);
                return $instance;
            },
        );
    }
