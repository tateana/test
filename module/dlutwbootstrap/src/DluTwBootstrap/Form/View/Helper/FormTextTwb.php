...
class FormTextTwb extends FormText
{
    ...
    public function render(ElementInterface $element,
		...
		//Append plain text
        if ($element->getOption('appendPlainText')) {
            $html           .= '<div class="text-addon">' . $escapeHelper($element->getOption('appendPlainText')) . '</div>';
        }
		//Append plain text
        if ($element->getOption('appendHtmlText')) {
            $html           .= '<div class="text-addon">' . $element->getOption('appendHtmlText') . '</div>';
        }
        if ($prepAppClass) {
