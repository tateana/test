 ...
 */
class FormFontPickerTwb extends FormText
{
    /**
     * @var FormUtil
     */
    ...
    public function render(ElementInterface $element,
        ...
        //Append font selector
        $html .= "\n" . '<div class="font-select-wrapper"><div class="bfh-selectbox bfh-fonts" data-font="Arial"' . 
                    ($element->getOption('availableFonts') ? ' data-available="' . $escapeHelper($element->getOption('availableFonts')) . '"' : '' ) . 
                '></div><button class="append-font btn btn-default">Add Font</button></div>';
