...
class FormControlsTwb extends AbstractViewHelper
{
    ...
    public function openTag(ElementInterface $element, $formType) {
        $class  = ($formType == \DluTwBootstrap\Form\FormUtil::FORM_TYPE_HORIZONTAL)? 'col-sm-8': ''; 
        
        if($element->hasAttribute('control-class')) {
            $class = $element->getAttribute('control-class');
        }
